...
public class Home extends JFrame implements ActionListener {
	...
	public Home() {
		...
		ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("librarymanagement/icons/second.png"));
		...
		ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("librarymanagement/icons/third.png"));
		...
		ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("librarymanagement/icons/fourth.png"));
		...
		ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("librarymanagement/icons/fifth.png"));
		...
		ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("librarymanagement/icons/sixth.png"));
		...
		ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("librarymanagement/icons/seventh.png"));

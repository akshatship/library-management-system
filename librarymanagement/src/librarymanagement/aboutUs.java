...
public class aboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public aboutUs() {
            ...
            super("About Me- Created by Akshat Thakur");
            ...
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("librarymanagement/icons/logo.png"));
            ...
            JLabel l6 = new JLabel("Developed By : Akshat Thakur");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Contact Me : takshat341@gmail.com");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);


            JLabel l9 = new JLabel("Follow Me on Instagram : akshat_01.exe");
